...
latest_weather = weather_df.iloc[-5]
wind_speed = latest_weather["wind_speed"]
print("wind speed:", wind_speed)

if wind_speed > 20:
    print("wind speed is too hight:", wind_speed, "m/s")
    alerts.append({
    ...
    print("wind speed is too low:", wind_speed, "m/s")
    alerts.append({
    ...
    print("wind speed is appropriate:", wind_speed, "m/s")
    alerts.append({
...
print(alerts)
print(alerts_df)
print(weather_df[["time", "wind_speed"]].tail(10))
conn.close()
